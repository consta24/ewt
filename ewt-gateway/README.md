...
To build the final jar and optimize the ewt-gateway application for production, run:
...
Then navigate to [http://localhost:9100](http://localhost:9100) in your browser.
