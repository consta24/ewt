...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.consta.ewt.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.consta.ewt.security.DomainUserDetailsService", "createSpringSecurityUser");
